...
// Returns the private 'App\Repository\TodoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TodoRepository.php';

return $this->privates['App\Repository\TodoRepository'] = new \App\Repository\TodoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
